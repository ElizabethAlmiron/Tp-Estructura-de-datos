...
universo.agregar_planeta("Kami's Lookout")
universo.agregar_planeta("Supreme Kai's Planet")

# Agregar rutas entre planetas con sus respectivos costos (distancia o tiempo de viaje)
universo.agregar_ruta("Tierra", "Namek", 3)
universo.agregar_ruta("Tierra", "Vegeta", 2)
universo.agregar_ruta("Namek", "Kami's Lookout", 4)
universo.agregar_ruta("Vegeta", "Kami's Lookout", 1)
universo.agregar_ruta("Kami's Lookout", "Supreme Kai's Planet", 5)
